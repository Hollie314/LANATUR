Shader "InTerra/Built-in/Object into Terrain Integration"
{
    Properties
    {
        ...
        _BaseTexturesTriplanar("Object Base Textures Triplanar", Float) = 0
        _BaseTexturesTriplanarSharpness("Object Base Textures Triplanar Sharpness", Range(2,10)) = 5
        ...
        _Intersection("Intersection Values", Vector) = (-0.5, 0.8, -2.0, 5.0)
        _Sharpness("Sharpness", Range(30,100)) = 80
        _NormIntersect("Normals intersection", Vector) = (0.0, 0.5, -0.2, 1.0)

        _Intersection2("Intersection2", Vector) = (-0.2, 0.6, -0.5, 1.5)
        ...
        [HideInInspector] _TerrainColorTintMode("Color Tint Mode", Float) = 0
        [HideInInspector] _TerrainColorTintDistance("Additional Normal Distance", vector) = (5, 15, 0, 50)
        ...
        [HideInInspector] _IsOnTerrain("", Float) = 1

        _GlobalWetnessDisabled("", Float) = 0

        //GUI properties
        [HideInInspector] _ParallaxFoldout("", Float) = 0
        [HideInInspector] _DetailFoldout("", Float) = 0
        [HideInInspector] _EmissionFoldout("", Float) = 0
        [HideInInspector] _TriplanarFoldout("", Float) = 0
        [HideInInspector] _TerrainLayersFoldout("", Float) = 1
        [HideInInspector] _TerrainIntersectionFoldout("", Float) = 1
        [HideInInspector] _SteepSlopesFoldout("", Float) = 1
    }
    ...
    SubShader {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
            ...
            SplatmapMix(IN, weight, mixedDiffuse, o.Normal, o.Occlusion, o.Metallic, o.Emission);
