Shader "InTerra/Built-in/Diffuse/Object into Terrain Integration (Diffuse)"
{
    Properties
    {
        ...
        _Intersection("Intersection Values", Vector) = (-0.5, 0.6, -2.0, 5.0)
        ...
        [HideInInspector] _IsOnTerrain("", Float) = 0

        _GlobalWetnessDisabled("", Float) = 0
        [HideInInspector] _PuddleHorizontalWeight("", Range(0, 1)) = 1
        [HideInInspector] _PuddleWetnessHorizontalWeight("", Range(0, 1)) = 1
