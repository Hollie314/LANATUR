              ...
              instance = VolumeManager.instance;
                if (instance != null)
                {
                    ...
                    if (volumeComponent != null)
                    {
                        ...
                        m_Material.SetFloat("_ProcessingIterations", volumeComponent.processingIterations.overrideState ? volumeComponent.processingIterations.value : BlendDefaultSettings.ProcessingIterations);
