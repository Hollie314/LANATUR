        ...
        return Mathf.Lerp(ab, cd, fy);
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                using (var builder = renderGraph.AddRasterRenderPass<PassData>("Object ID Render", out var passData))
                {
                    ...
                    builder.SetGlobalTextureAfterPass(passData.depthTexture, Shader.PropertyToID("_ObjectDepthTexture"));

                var camPos = cameraData.camera;
                Terrain currentTerrain = GetTerrainAt(camPos.transform.position);


                 if (currentTerrain != null && currentTerrain.drawInstanced && currentTerrain!=sourceTerrain)
                {
                    ...
                    builder.SetRenderFunc((PassData data, RasterGraphContext context) =>
                    {
                        ...
                        if (sourceTerrain != null && sourceTerrain.drawInstanced && mesh != null)
                        {
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                cmd.SetGlobalTexture("_ObjectDepthTexture", depthHandle);
            ...
            public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
            {
                // No configuration needed for Render Graph path
            }

            [System.Obsolete]
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                // Execution handled by RecordRenderGraph for Unity 6
            }
