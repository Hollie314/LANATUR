...
Shader "InTerra/HDRP Tessellation/Terrain (Lit with Features) 2022.2"
{
    Properties
    {
        ...
        [HideInInspector] _DistanceBlendingFoldout("", Float) = 0
        [HideInInspector] _HeightmapBlendingFoldout("", Float) = 0
        [HideInInspector] _TriplanarMappingFoldout("", Float) = 0
        [HideInInspector] _Terrain_ParallaxFoldout("", Float) = 0
        [HideInInspector] _TracksFoldout("", Float) = 0
        [HideInInspector] _TessellationFoldout("", Float) = 0
        ...
        _TerrainColorTintMode("Color Tint Mode", Float) = 0
        _TerrainColorTintDistance("Additional Normal Distance",  vector) = (3,10,0,25)
        ...
        _TerrainAddTessellationTexture("Aditional Tessellation Texture", 2D) = "black" {}
        _TerrainAddTessellationHeight("Aditional Tessellation Height", Range(1, 0)) = 0
        _TerrainAddTessellationOffset("Aditional Tessellation Offset", Range(-0.5, 0.5)) = 0
        _TerrainAddTessTextureType("Aditional Tessellation Texture Type", Range(1, 0)) = 0
        ...
        _PuddleHorizontalWeight("", Range(0,1)) = 0.8
        _PuddleWetnessHorizontalWeight("", Range(0,1)) = 0.5
