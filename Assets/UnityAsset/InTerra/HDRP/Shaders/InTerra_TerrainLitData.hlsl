...
float3 ConvertToNormalTS(float3 normalData, float3 tangentWS, float3 bitangentWS)
{
    ...
    float _TerrainAddTessellationHeight;
    float _TerrainAddTessellationOffset;
    float _TerrainAddTessTextureType;
    float4 _TerrainAddTessellationTexture_ST;
    TEXTURE2D(_TerrainAddTessellationTexture);
    SAMPLER(sampler_TerrainAddTessellationTexture);
