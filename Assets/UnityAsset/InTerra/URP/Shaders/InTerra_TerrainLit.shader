...
Shader "InTerra/URP/Terrain (Lit with Features)"
{
    Properties
    {
        ...
        _TerrainColorTintDistance("Additional Color Distance",  vector) = (3,15,0,50)
        _TerrainColorTintMode("Color Tint Mode", Float) = 0
        _TerrainColorTintMTB("Color Tint Material Property Block", Float) = 0
        _TerrainNormalTintMTB("Normal Tint Material Property Block", Float) = 0       
        ...
        _TerrainNormalTintDistance("Additional Normal Distance",  vector) = (3,10,0,50)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local_fragment __ _LAYERS_TWO _LAYERS_EIGHT _LAYERS_SIXTEEN
