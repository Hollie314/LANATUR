Shader "InTerra/Built-in/Mesh Terrain (Standard)"
{
    Properties
    {
        ...
        [HideInInspector] _Control1("cntrl1", 2D) = "black" {}
        ...
        [HideInInspector] _TwoLayersOnly("", Float) = 0
        ...
        [HideInInspector] _NormalsFromHeightmap("", Float) = 0
